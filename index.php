...
<body>
    ...
    <script>
        ...
        const banglaQuotes = [
            ...
            { text: "এখানে আমরা সবাই পাগল।", author: "— চেশায়ার বিড়াল, লুইস ক্যারল" },
            { text: "তুমি যদি না জানো কোথায় যেতে চাও, তবে কোন পথে যাবে, তাতে কিছু যায় আসে না।", author: "— চেশায়ার বিড়াল" },
